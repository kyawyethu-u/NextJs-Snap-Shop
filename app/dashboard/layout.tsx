...
import { ChartNoAxesCombined, Package, PackagePlus, Settings, Truck } from "lucide-react";
...
export default async function Layout({
    ...
    const routes = session?.user.role === "admin" ? [...privateRoutes,...publicRoutes] : publicRoutes;
        return (
        <>
